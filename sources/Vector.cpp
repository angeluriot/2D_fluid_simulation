...
void Vector::operator=(const sf::Vector2f& vector)
{
	x = vector.x;
	y = vector.y;
}

void Vector::operator=(const sf::Vector2i& vector)
{
	x = vector.x;
	y = vector.y;
}
...
// Donne la distance entre deux points au carré (en mètres)

double get_distance2(const Vector& point_1, const Vector& point_2)
{
	return (point_2 - point_1).get_norm2();
}
